...
public class EclipseToCrinemaft 
{ 
	...
	if (target.exists())
	{
    	...
    	copyDir(new File("C:\\Dokumente und Einstellungen\\Fabi\\git\\Crinemaft-resources\\Crinemaft"), target);
